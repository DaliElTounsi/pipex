...
/** @brief Libère la structure t_parse et affiche une erreur avec perror avant de quitter.
...
/** @brief Cherche une commande dans le PATH et vérifie si elle est exécutable.
 *  @param list Structure contenant les informations de parsing.
 *  @param cmd Commande à chercher.
 *  @param error_msg Message d'erreur à afficher si la commande n'est pas trouvée.
...
/** @brief Libère la structure t_parse et quitte le programme avec un code d'erreur.
 *  @param list Structure t_parse à libérer.
 *  @return Ne retourne rien, quitte avec exit(1).
 */
...
// fonction_utils_2.c
/** @brief Vérifie path_env et les commandes, libère les ressources et quitte en cas d'erreur.
 ...
 *  @param list Structure contenant les informations de parsing.
 *  @param cmd Commande à chercher.
 *  @return Ne retourne rien, met à jour list->found et list->cmd_path si la commande est trouvée.
 */
